                ...
                <div class="container-fluid">
                    ...
                    <div class="form-group" style="margin-top:10px;">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="<?php echo $row['product_review']; ?>" name="review">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" value="<?php echo $row['product_price']; ?>" name="price">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
